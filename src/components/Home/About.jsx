...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Booked my mk1 Jetta in for a stage 1 polish and I was absolutely shocked how it came up, absolute amazing job, couldn’t be happier with the finish, great communication, and just such a easy process, even let me leave it a extra night to to try avoid the rain",
    name: "Jordan Ramsdale",
  },
